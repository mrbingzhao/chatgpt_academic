...
proxies, API_URL, API_KEY, TIMEOUT_SECONDS, MAX_RETRY, LLM_MODEL,CONVERSATION_ID = \
    get_conf('proxies', 'API_URL', 'API_KEY', 'TIMEOUT_SECONDS', 'MAX_RETRY', 'LLM_MODEL','CONVERSATION_ID')
...
def generate_payload(inputs, top_p, temperature, history, system_prompt, stream):
    ...
    payload = {
        ...
        "presence_penalty": 0,
        "frequency_penalty": 0,
        # "conversation_id":CONVERSATION_ID,#网页版支持，api不支持
    }
